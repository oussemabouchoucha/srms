    ...
    <div class="main">
        <form action="" method="post">
            ...
            <legend>Enter Results</legend>
                ...
                <input type="text" name="rno" placeholder="Num CIN">
...
<?php
    if(isset($_POST['rno'],$_POST['p1'],$_POST['p2'],$_POST['p3'],$_POST['p4'],$_POST['p5']))
    {
        ...
        if (empty($class_name) or empty($rno) or $p1>100 or  $p2>100 or $p3>100 or $p4>100 or $p5>100 or $p1<0 or  $p2<0 or $p3<0 or $p4<0 or $p5<0 ) {
            ...
            if(empty($rno))
                echo '<p class="error">Please enter Num CIN</p>';
            if(preg_match("/[a-z]/i",$rno))
                echo '<p class="error">Please enter valid Num CIN</p>';
            if(preg_match("/[a-z]/i",$marks))
                echo '<p class="error">Please enter valid Results</p>';
